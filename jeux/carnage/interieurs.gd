...
static func _atelier() -> Dictionary:
	return {
		...
		"meubles": [
			...
			contre("bookcaseClosedWide", "N", 4.60, 3),
...
static func _loft() -> Dictionary:
	return {
		...
		"meubles": [
			...
			pose("chairModernCushion", 5.00, 0.90, 3),
