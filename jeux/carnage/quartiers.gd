...
const CATALOGUE := {
	...
	"banlieue": {
		"nom": "La Banlieue", "origine": Vector2(-17.0, -16.0), "angle": 12.0, "graine": 311,
		"herbe": Color("#83a05e"), "roche": Color("#93897a"),
		"hauteurs": {"M": [9.0, 14.0], "C": [12.0, 18.0]},
		"plan": [
			"......M'..#^^..,......",
			".....MMM.'#^^mM,,.....",
			"....#mmM'^#MMMm^^..M..",
	...
	"cites": {
		"nom": "Les Cités", "origine": Vector2(18.0, -21.0), "angle": -22.0, "graine": 1972,
		"herbe": Color("#778a5a"), "roche": Color("#8a8478"),
		"hauteurs": {"B": [34.0, 52.0]},
		"plan": [
			"........,^',......",
			"......bb,BBB......",
			"....#,^^^,,^'#bb..",
	...
	"industrie": {
		"nom": "La Zone industrielle", "origine": Vector2(38.0, 2.0), "angle": 33.0, "graine": 808,
		"herbe": Color("#8b8f6a"), "roche": Color("#877f70"),
		"hauteurs": {"H": [12.0, 26.0]},
		"plan": [
			"......,,Hh.,#%......",
			".....#%XHhh%#X,.....",
			"....^#hhHHHh#hhH%H..",
...
const PONTS := [
	[Vector2(1.5, 14.6), Vector2(-1.4, 18.6), 0.0, 1.0],    # centre → vieille ville
	[Vector2(26.0, 15.4), Vector2(26.6, 21.4), 5.0, 0.0],   # centre → port
	[Vector2(6.0, -0.2), Vector2(6.6, -4.4), 0.0, 0.0],     # centre → banlieue
	[Vector2(22.0, 0.0), Vector2(24.0, -3.4), 0.0, 0.0],    # centre → les cités
	[Vector2(31.6, 6.0), Vector2(37.4, 6.4), 5.0, 0.0],     # ville haute → industrie
]
