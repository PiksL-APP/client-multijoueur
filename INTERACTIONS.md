...
| ~~Phase 7 — garages de modification~~ | **Fait.** Pas un second garage : un garage sur deux vend en plus, sur cinq pastilles où l'on se gare. La couleur de la carrosserie change vraiment depuis (`CONCEPTION-ATELIER.md`). Reste ouverte : la bombe déclenchée à distance (plus de touche libre). |
