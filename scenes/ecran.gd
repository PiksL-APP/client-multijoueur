...
## Le plan de jeu à deux dimensions. Le hub est en pixel art vu de dessus,
## les jeux sont en 3D : les deux mondes ne se mélangent jamais dans un même
## écran, mais le socle sait porter l'un ou l'autre.
##
